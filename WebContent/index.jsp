...
<%@ include file="/WEB-INF/views/common/header-menu.jsp" %>
 <!-- Bootstrap core CSS -->
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        <div class="intro-heading text-uppercase" style='padding-bottom: 30px;'>
        	지금 다양한 국내 여행지를 검색하세요.
        </div>
        <form class="IndexsearchFrm" method="get">
       		<input type="text" id="IndexsearchFrm" placeholder="#서촌 #맛집" size='50px;' />
  ...
  <section class="page-section" id="recommend-theme">
    <!-- 7월의 여행테마 -->
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h1 class="section-heading text-uppercase" style='color: #212529;'>7월의 여행테마 : 여름바캉스</h1>
