 		...
 		if(e.key=="Enter"){
 			...
 			var area2 = ["강화군","계양구","미추홀구","남동구","동구","부평구","서구","연수구","옹진군","중구"];
 		  	var area3 = ["대덕구","동구","서구","유성구","중구"];
 		   	...
 		   	for(var i=0;i<area1.length;i++){if(area1[i]==$("#searchKwd").val()){sido1=1;gugun1=i+1;}}
 		   	for(var i=0;i<area2.length;i++){if(area2[i]==$("#searchKwd").val()){sido1=2;gugun1=i+1;}}
 		  	for(var i=0;i<area3.length;i++){if(area3[i]==$("#searchKwd").val()){sido1=3;gugun1=i+1;}}
 		 	for(var i=0;i<area4.length;i++){if(area4[i]==$("#searchKwd").val()){sido1=4;gugun1=i+1;}}
 			for(var i=0;i<area5.length;i++){if(area5[i]==$("#searchKwd").val()){sido1=5;gugun1=i+1;}}
 			for(var i=0;i<area6.length;i++){if(area6[i]==$("#searchKwd").val()){sido1=6;gugun1=i+1;}}
 			for(var i=0;i<area7.length;i++){if(area7[i]==$("#searchKwd").val()){sido1=7;gugun1=i+1;}}
 			for(var i=0;i<area8.length;i++){if(area8[i]==$("#searchKwd").val()){sido1=8;gugun1=i+1;}}
 			for(var i=0;i<area9.length;i++){if(area9[i]==$("#searchKwd").val()){sido1=31;gugun1=i+1;}}
 			for(var i=0;i<area10.length;i++){if(area10[i]==$("#searchKwd").val()){sido1=32;gugun1=i+1;}}
 			for(var i=0;i<area11.length;i++){if(area11[i]==$("#searchKwd").val()){sido1=33;gugun1=i+1;}}
 			for(var i=0;i<area12.length;i++){if(area12[i]==$("#searchKwd").val()){sido1=34;gugun1=i+1;}}
 			for(var i=0;i<area13.length;i++){if(area13[i]==$("#searchKwd").val()){sido1=35;gugun1=i+1;}}
 			for(var i=0;i<area14.length;i++){if(area14[i]==$("#searchKwd").val()){sido1=36;gugun1=i+1;}}
 			for(var i=0;i<area15.length;i++){if(area15[i]==$("#searchKwd").val()){sido1=37;gugun1=i+1;}}
 			for(var i=0;i<area16.length;i++){if(area16[i]==$("#searchKwd").val()){sido1=38;gugun1=i+1;}}
 			for(var i=0;i<area17.length;i++){if(area17[i]==$("#searchKwd").val()){sido1=39;gugun1=i+1;}}
 			if(!sido1&&!gugun1){
 			   alert("올바른 구/군을 입력해주세요");
 			   return;
 		    }
