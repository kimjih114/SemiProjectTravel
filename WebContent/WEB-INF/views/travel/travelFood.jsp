<%@page import="travel.model.vo.TravelFood"%>
<%@page import="java.util.List"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	List<TravelFood> list=(List<TravelFood>)request.getAttribute("list");
	String pageBar=(String)request.getAttribute("pageBar");
	String searchAddress=request.getParameter("searchAddress");
	String[] addressArray=searchAddress.split(" ");
	String sido=addressArray[0];
	String gugun=addressArray[1];
%>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-sm-6 mb-4">
				<div class="card h-100">
					...
					<div class="card-body">
						<h4 class="card-title">
							<a href="#"><%=list.get(i).getFoodName() %></a>
						</h4>
						<p class="card-text"><%=list.get(i).getFoodContent() %></p>
					</div>
				</div>
			</div>
