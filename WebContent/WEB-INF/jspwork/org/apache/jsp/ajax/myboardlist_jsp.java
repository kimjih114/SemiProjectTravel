 ...
 * Generated at: 2019-08-19 02:18:01 UTC
...
public final class myboardlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	ProfileSNS userLoggedInProfile = new SNSService().selectOneProfile(userLoggedIn.getUserId());
      ...
      out.write("\tif ($(\".mcomment-editor\").css(\"display\") == \"none\"){\n");
      out.write("\t\t$(\".mcomment-editor\").css(\"display\", \"block\");\n");
      ...
      out.write("\t\t$(\".mcomment-editor\").css(\"display\", \"none\");\n");
      out.write("\t\t$(btn).removeClass('btn-dark').addClass('btn-primary');\n");
      out.write("\t\t$(btn).text('답글');\n");
      out.write("\t} \n");
      out.write("\t\n");
      ...
      out.write("';\n");
      out.write("\n");
      out.write("\tconsole.log(commentNo);\n");
      out.write("\tconsole.log(commentContent);\n");
      out.write("\tconsole.log(commentNickname);\n");
      out.write("\tconsole.log(commentProfile);\n");
      out.write("\t\n");
      out.write("\t\n");
      out.write("\tvar param = {\n");
      ...
      out.write("\t\t\t\t\t\t\t\thtml+=\"<button class='btn btn-success' onclick='updateCommentFrm(this)' value='\"+data.commentNo+\"' style='float:right; margin-right: 2px;'>수정</button>\t\";\t\n");
      out.write("\t\t\t\t\t\t\t\thtml+=\"</div>\"\n");
      out.write("\t\t\t\t\t\t\thtml+=\"</td>\";\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\n");
      ...
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\tvar html ='';\n");
      out.write("\t\t\t\t\t\thtml+=\"<tr class='level1' newL1='newL1' id='comment\"+data.commentNo+\"'>\";\n");
      out.write("\t\t\t\t\t\thtml+=\"<td class='timeline-boardcontent-sns' style='width:529px;'>\";\n");
      out.write("\t\t\t\t\t\thtml+=\"<a href='");
      out.print(request.getContextPath() );
      out.write("/story/storyMain?mypage=\"+data.commentWriter+\"'class='comment-writer' style='color:black; font-weight:700; font-size:1.2em; margin-right:3px;'><img src='");
      ...
      out.write("\t\t\t\t\t\t\thtml+=\"<div class='mcomment-editor'>\"\n");
      ...
      out.write("\t\t\t\t\t\t\t\thtml+=\"<button type='button' class='btn btn-primary' onclick='insertCoCo(this)' value='\"+data.boardNo+\"' style='width:77px; height:68px; margin:5px 2px;'>등록</button>\";\t\n");
      out.write("\t\t\t\t\t\t\thtml+=\"</div>\";\n");
      out.write("\t\t\t\t\t\thtml+=\"</td>\";\n");
      out.write("\t\t\t\t\t\thtml+=\"</tr>\";\n");
      out.write("\t\t\t\t\t\t\n");
      ...
      out.write("\t\t\t\t\tvar html =''\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t//html+=\"<tr class=level2 id='comment\"+data.commentNo+\"'>\";\n");
      out.write("\t\t\t\t\t\thtml+=\"<td class='timeline-boardcontent-sns' style='width:472px; float:right'>\";\n");
      out.write("\t\t\t\t\t\thtml+=\"<a href='");
      out.print(request.getContextPath() );
      out.write("/story/storyMain?mypage=\"+data.commentWriter+\"'class='comment-writer' style='color:black; font-weight:700; font-size:1.2em; margin-right:3px;'><img src='");
      out.print(request.getContextPath());
      ...
      out.write("\t\t\t\t\t\t\t\t\thtml+=\"<td class='timeline-boardcontent-sns' style='cursor:pointer;' onclick='openComment(this)' >댓글(\"+data.commentSNSList.length+\")</td>\";\n");
      out.write("\t\t\t\t\t\t\t\t} else{\n");
      ...
      out.write("\t\t\t\t\t\thtml+=\"<button type='button' class='btn btn-primary' onclick='insertComment(this);' value='\"+tl.boardSNS.boardNo+\"' style='float:right; width:77px; height:68px; margin:5px 5px 5px 2px;'>등록</button>\";\t\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\thtml+=\"</div>\";\n");
      out.write("\t\t\t\t\t\thtml+=\"<table class='tbl-comment'>\";\n");
      out.write("\t\t\t\t\t\tif(tl.commentSNSList.length>0){\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\thtml+=\"<div class='mcomment-editor'>\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\thtml+=\"<textarea style='margin:7px 2px; float:left;' name='boardCommentContent' class='boardCommentContent' cols='45' rows='3'></textarea>\";\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\thtml+=\"<button type='button' class='btn btn-primary' onclick='insertCoCo(this)' value='\"+tl.boardSNS.boardNo+\"' style='width:77px; height:68px; margin:5px 2px;'>등록</button>\";\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\thtml+=\"</div>\";\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+=\"</td>\";\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+=\"</tr>\";\n");
      out.write("\t\t\t\t\t\t\t\t\t\n");
