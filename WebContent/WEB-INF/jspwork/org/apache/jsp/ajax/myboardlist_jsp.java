 ...
 * Generated at: 2019-08-15 19:35:17 UTC
...
public final class myboardlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	User userLoggedIn = (User)session.getAttribute("userLoggedIn");
      ...
      out.write("\t\t\t\tsuccess : function(data){\t\n");
      out.write("\t\t\t\t\tvar html = '';\n");
      out.write("\t\t\t\t\thtml += \"<form action='' name='snsUpload'\";\n");
      out.write("\t\t\t\t\thtml += \"class='snsUpload'\";\n");
      ...
      out.write("\t\t\t\t\thtml += \"<textarea name='reviewContent' id='reviewContent' cols='58' rows='5' required></textarea>\";\n");
      out.write("\t\t\t\t\thtml += \"<div id='contentIdList'>\";\n");
      out.write("\t\t\t\t\thtml += \"</div>\";\n");
      out.write("\t\t\t\t\thtml += \"</td>\";\n");
      out.write("\t\t\t\t\thtml += \"</tr>\";\n");
      out.write("\t\t\t\t\thtml += \"<tr>\";\n");
      out.write("\t\t\t\t\thtml += \"<td style='float:left; padding:10px; text-align:left;'>\";\n");
      ...
      out.write("\t\t\t\t\thtml += \"<input name='fileupload' id='fileupload' type='file' accept='image/*' style='margin-bottom:10px;' multiple />\";\n");
      out.write("\t\t\t\t\thtml += \"<div style='display:table;'>\";\n");
      out.write("\t\t\t\t\thtml += \"<div class='imgs_wrap'></div>\";\n");
      out.write("\t\t\t\t\thtml += \"</div>\";\n");
      out.write("\t\t\t\t\thtml += \"</td>\";\n");
      out.write("\t\t\t\t\thtml += \"</tr>\";\n");
      out.write("\t\t\t\t\thtml += \"<tr>\";\n");
      out.write("\t\t\t\t\thtml += \"<td style='float:left; padding:10px;'>\";\n");
      out.write("\t\t\t\t\thtml += \"<input type='radio' name='boardtype' id='public' value='P' checked />\";\n");
      out.write("\t\t\t\t\thtml += \"<label for='public'>전체공개</label> &nbsp;\";\n");
      out.write("\t\t\t\t\thtml += \"<input type='radio' name='boardtype' id='followOnly' value='F' />\";\n");
      out.write("\t\t\t\t\thtml += \"<label for='followOnly'>팔로워공개</label> &nbsp;\";\n");
      out.write("\t\t\t\t\thtml += \"<input type='radio' name='boardtype' id='locked' value='L' />\";\n");
      out.write("\t\t\t\t\thtml += \"<label for='locked'>비공개</label>\";\n");
      out.write("\t\t\t\t\thtml += \"<br>\";\n");
      out.write("\t\t\t\t\thtml += \"<input type='submit' id='btnSubmit' value='포스트 등록' style='float:right; margin-top : 10px;''>\";\n");
      out.write("\t\t\t\t\thtml += \"</td>\";\n");
      out.write("\t\t\t\t\thtml += \"</tr>\";\n");
