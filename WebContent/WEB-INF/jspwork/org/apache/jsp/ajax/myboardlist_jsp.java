 ...
 * Generated at: 2019-08-17 05:00:19 UTC
...
public final class myboardlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	User userLoggedIn = (User)session.getAttribute("userLoggedIn");
      ...
      out.write("\t\t\t\t\t\thtml += \"<input type='radio' name='boardtype' value='P' />\";\n");
      out.write("\t\t\t\t\t\thtml += \"<label for='public'>전체공개</label> &nbsp;\";\n");
      out.write("\t\t\t\t\t\thtml += \"<input type='radio' name='boardtype' value='F' checked />\";\n");
      out.write("\t\t\t\t\t\thtml += \"<label for='followOnly'>팔로워공개</label> &nbsp;\";\n");
      out.write("\t\t\t\t\t\thtml += \"<input type='radio' name='boardtype' value='L' />\";\n");
      out.write("\t\t\t\t\t\thtml += \"<label for='locked'>비공개</label>\";\n");
      out.write("\t\t\t\t\t}\n");
      ...
      out.write("\t\t\t\t\t\thtml += \"<input type='radio' name='boardtype' value='F' />\";\n");
      out.write("\t\t\t\t\t\thtml += \"<label for='followOnly'>팔로워공개</label> &nbsp;\";\n");
      out.write("\t\t\t\t\t\thtml += \"<input type='radio' name='boardtype' value='L' checked  />\";\n");
      out.write("\t\t\t\t\t\thtml += \"<label for='locked'>비공개</label>\";\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t\thtml += \"<br>\";\n");
