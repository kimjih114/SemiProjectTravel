 ...
 * Generated at: 2019-08-18 06:06:05 UTC
...
public final class myboardlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	User userLoggedIn = (User)session.getAttribute("userLoggedIn");
      ...
      out.print(request.getContextPath() );
      out.write("/img/beforelike.png' alt='' style='padding-top:2px; padding-bottom:-2px; width: 20px; height:20px'/><span>\"+data.likeSNSList.length+\"</span>&nbsp;&nbsp;<img src='");
      out.print(request.getContextPath() );
      out.write("/img/alarm.png' alt='' style='width: 20px; height:20px'/></span>\";\n");
      out.write("\t\t\t\t\t\t\t\t\t\t} else{\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\thtml+=\"<span style='float: right; margin-right:10px; cursor:pointer' ><img boardNo='\"+data.boardSNS.boardNo+\"'  src='");
      out.print(request.getContextPath() );
      out.write("/img/beforelike.png' alt='' style='padding-top:2px; padding-bottom:-2px; width: 20px; height:20px'/><span class='likeCnt'>\"+data.likeSNSList.length+\"</span>&nbsp;&nbsp;<img src='");
      out.print(request.getContextPath() );
      out.write("/img/alarm.png' alt='' style='width: 20px; height:20px'/></span>\";\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\t\t\t}else{\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\thtml+=\"<span style='float: right; margin-right:10px;' ><img src='");
      out.print(request.getContextPath() );
      out.write("/img/beforelike.png' alt='' style='padding-top:2px; padding-bottom:-2px; width: 20px; height:20px'/><span>0/span>&nbsp;&nbsp;<img src='");
      out.print(request.getContextPath() );
      out.write("/img/alarm.png' alt='' style='width: 20px; height:20px'/></span>\";\n");
      out.write("\t\t\t\t\t\t\t\t\t\t} else{\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\thtml+=\"<span style='float: right; margin-right:10px; cursor:pointer' ><img boardNo='\"+data.boardSNS.boardNo+\"' src='");
      ...
      out.print(request.getContextPath() );
      out.write("/img/afterlike.png' alt='' style='padding-top:2px; padding-bottom:-2px; width: 20px; height:20px'/><span>\"+tl.likeSNSList.length+\"</span><img src='");
      out.print(request.getContextPath() );
      out.write("/img/alarm.png' alt='' style='width: 20px; height:20px'/></span>\";\n");
      out.write("\t\t\t\t\t\t\t} else{\n");
