 ...
 * Generated at: 2019-08-18 10:50:47 UTC
...
public final class myboardlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	User userLoggedIn = (User)session.getAttribute("userLoggedIn");
      ...
      out.write("\tconsole.log($(img).prop('src'));\n");
      out.write("\tif($(img).prop('src')== 'http://localhost:8080/trav/img/beforelike.png'){\n");
      out.write("\t\tvar param = {\n");
      ...
      out.write("\t\t\t\t});\n");
      out.write("\t}\n");
      out.write("\telse if ($(img).prop('src')== 'http://localhost:8080/trav/img/afterlike.png'){\n");
      out.write("\t\tvar param = {\n");
      out.write("\t\t\t\tboardNo : boardNo,\n");
      out.write("\t\t\t\tuserId : '");
      out.print(userLoggedIn.getUserId() );
      ...
      out.write("\t\t\t\t\t\thtml += \"<div class='mpanel'  style='position: absolute; left:83px; top:41px; background:white; z-index:1;  width:200px;'>파일 \"+data.imageSNSList.length+\"개</div>\";\n");
      out.write("\t\t\t\t\t} else {\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\thtml+=\"<td class='timeline-boardcontent-sns' style='cursor:pointer; onclick='openComment()'' >댓글(\"+data.commentSNSList.length+\")</td>\";\n");
      out.write("\t\t\t\t\t\t\t\t} else{\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+=\"<td class='timeline-boardcontent-sns' style='cursor:pointer;'>댓글(0)</td>\";\n");
      out.write("\t\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\t\thtml+=\"</tr>\";\n");
      out.write("\t\t\t\t\t\t\t\thtml+=\"<tr>\";\n");
      out.write("\t\t\t\t\t\t\t\thtml+=\"<td class='timeline-boardcontent-sns'>\";\n");
      ...
      out.write("\t\t\t\t\thtml+=\"<span style='font-weight: 600'><a class='nickname-sns' href='");
      out.print(request.getContextPath() );
      out.write("/story/storyMain?mypage=\"+tl.boardSNS.boardWriter+\"'>\"+tl.profileSNS.profileUserNickname+\"</a></span>\";\n");
      ...
      out.write("\t\t\t\t\t\thtml+=\"<td class='timeline-boardcontent-sns' style='cursor:pointer; onclick=openComment();'>댓글(\"+tl.commentSNSList.length+\")</td>\";\n");
      out.write("\t\t\t\t\t} else{\n");
      out.write("\t\t\t\t\t\thtml+=\"<td class='timeline-boardcontent-sns' style='cursor:pointer;'>댓글(0)</td>\";\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\thtml+=\"<div class='comment-editor'>\"\n");
      out.write("\t\t\t\t\thtml+=\"<form action='' name='boardCommentFrm'method='post'>\";\n");
      out.write("\t\t\t\t\thtml+=\"<input type='hidde'\" name='boardRef' value='' />\";\n");
      out.write("\t\t\t\t\thtml+=\"<input type='hidden' name='boardCommentWriter' value='' />\";\n");
      out.write("\t\t\t\t\thtml+=\"<input type='hidden' name=\"boardCommentLevel' value='1' />\";\n");
      out.write("\t\t\t\t\thtml+=\"<input type='hidden' name='boardCommentRef' value='0' />\";\n");
      out.write("\t\t\t\t\thtml+=\"<textarea name='boardCommentContent' class='boardCommentContent' cols='60' rows='3'></textarea>\";\n");
      out.write("\t\t\t\t\thtml+=\"<button type='button' clss='btn-insert'>등록</button>\";\t\n");
      out.write("\t\t\t\t\thtml+=\"</form>\";\n");
      out.write("\t\t\t\t\thtml+=\"</div>\";\n");
      out.write("\t\t\t\t\t<!-- 댓글목록테이블 -->\n");
      out.write("\t\t\t\t\thtml+=\"<table class='tbl-comment'>\";\n");
      out.write("\t\t\t\t\thtml+=\"<tr class=level1>\";\n");
      out.write("\t\t\t\t\thtml+=\"<td class='timeline-boardcontent-sns' style='width:508px;'>\";\n");
      out.write("\t\t\t\t\thtml+=\"<span class=comment-writer>작성자</span>\";\n");
      out.write("\t\t\t\t\thtml+=\"<span class=comment-date>대댓날짜</span>\";\n");
      out.write("\t\t\t\t\thtml+=\"<br />\";\n");
      out.write("\t\t\t\t\thtml+=\"여긴 내용\";\n");
      out.write("\t\t\t\t\thtml+=\"<button class='btn-reply' value='' style='float:right;'>답글</button>\";\n");
      out.write("\t\t\t\t\thtml+=\"<button class='btn-delete' value=\"\" style='float:right;'>삭제</button>\t\";\t\n");
      out.write("\t\t\t\t\thtml+=\"</td>\";\n");
      out.write("\t\t\t\t\thtml+=\"</tr>\";\n");
      out.write("\t\t\t\t\thtml+=\"<tr class=level2>\";\n");
      out.write("\t\t\t\t\thtml+=\"<td>\";\n");
      out.write("\t\t\t\t\thtml+=\"<span class=comment-writer>대댓작성자</span>\";\n");
      out.write("\t\t\t\t\thtml+=\"<span class=comment-date>대댓날짜 </span>\";\n");
      out.write("\t\t\t\t\thtml+=\"<br />\";\n");
      out.write("\t\t\t\t\thtml+=\"여기내용\";\n");
      out.write("\t\t\t\t\thtml+=\"<button class='btn-delete' value=\"\" style='float:right;'>삭제</button>\";\n");
