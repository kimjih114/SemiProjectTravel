 ...
 * Generated at: 2019-08-15 23:13:34 UTC
...
public final class myboardlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	User userLoggedIn = (User)session.getAttribute("userLoggedIn");
      ...
      out.write("\tvar mfilesTempArrLen = mfilesTempArr.length;\n");
      out.write("\t\n");
      ...
      out.write("\t\t\tvar html = \"<div class='mimgs'><img src=\\\"\"+e.target.result+\"\\\" />\";\n");
      ...
      out.write("\t\t \t}\n");
      out.write("\t\t\thtml += \"<div><span>\"+mfilename+\"</span><br>\";\n");
      ...
      out.write("\t\t\t\t\thtml += \"enctype='multipart/form-data' style='border:1px solid black; padding: 10px; margin-bottom:10px;'>\";\n");
      out.write("\t\t\t\t\thtml += \"<table class='postFrm' style='padding:10px;'>\";\n");
      out.write("\t\t\t\t\thtml += \"<tr>\";\n");
      out.write("\t\t\t\t\thtml += \"<td style='font-weight: 700; padding:10px; text-align:left;'>여행 후기를 수정합니다.</td>\";\n");
      out.write("\t\t\t\t\thtml += \"</tr>\";\n");
      out.write("\t\t\t\t\thtml += \"<tr>\";\n");
      out.write("\t\t\t\t\thtml += \"<td style='style='font-weight: 700; float:left; padding:10px'>\";\n");
      out.write("\t\t\t\t\thtml += \"<div class='travelsrchM' style='padding: 10px;'></div>\";\n");
      out.write("\t\t\t\t\thtml += \"</td>\";\n");
      out.write("\t\t\t\t\thtml += \"</tr>\";\n");
      out.write("\t\t\t\t\thtml += \"<tr>\";\n");
      out.write("\t\t\t\t\thtml += \"<td style='font-weight: 700; float:left; padding:10px;'>\";\n");
      out.write("\t\t\t\t\thtml += \"<label for='reviewContent' style='font-weight: 700; float:left;'>어떤 여행을 하셨나요?</label>\";\n");
      out.write("\t\t\t\t\thtml += \"<textarea name='reviewContent' id='reviewContent' cols='58' rows='5' required>\"+data.boardSNS.boardContent+\"</textarea>\";\n");
      out.write("\t\t\t\t\thtml += \"<div id='contentIdList'>\";\n");
      out.write("\t\t\t\t\thtml += \"</div>\";\n");
      out.write("\t\t\t\t\thtml += \"</td>\";\n");
      out.write("\t\t\t\t\thtml += \"</tr>\";\n");
      out.write("\t\t\t\t\thtml += \"<tr>\";\n");
      out.write("\t\t\t\t\thtml += \"<td style='float:left; padding:10px; text-align:left; float:left; width:506px;'>\";\n");
      out.write("\t\t\t\t\thtml += \"<label for='' style='font-weight: 700;  float:left; margin-bottom:10px;'>첨부이미지</label>\";\n");
      out.write("\t\t\t\t\thtml += \"<span style='font-size:0.5em; color:gray;'>최대 5개까지 등록 가능합니다.</span><br>\";\t\t\n");
      out.write("\t\t\t\t\thtml+=\"<div style='position:relative; '>\"\n");
      out.write("\t\t\t\t\tif(data.imageSNSList.length>0){\n");
      out.write("\t\t\t\t\t\thtml +=\"<div class='panel' style='position:absolute; width: 400px; left:73px; top:6px; text-align:left; z-index:1; background:white;'>파일 \"+data.imageSNSList.length+\"개</div>\"\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t\telse{\n");
      out.write("\t\t\t\t\t\thtml +=\"<div class='panel' style='position:absolute; width: 400px; left:73px; top:6px; text-align:left; z-index:1; background:white;'>선택된 파일 없음</div>\"\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t\thtml += \"<input name='fileModify' id='fileModify' type='file' accept='image/*' onchange='mHandleImgsFilesSelect(event)' style='margin-bottom:10px; position:absolute; top:4px; left:0px;' multiple />\";\n");
      out.write("\t\t\t\t\thtml+=\"</div>\"\n");
      out.write("\t\t\t\t\thtml += \"<div style='display:table; height:100px;'>\";\n");
      out.write("\t\t\t\t\thtml += \"<div class='mimgs_wrap' style=' text-align:center; vertical-align:middle; table-layout:fixed; width:100%; height:100px; display:block; margin-top:'>\";\n");
      out.write("\t\t\t\t\tif(data.imageSNSList.length>0){\n");
      out.write("\t\t\t\t\t\tfor(var e=0; e<data.imageSNSList.length; e++){\n");
      out.write("\t\t\t\t\t\t\thtml+=\"<div class='mimgs' style='display:talbe-cell; max-width:100px; font-size:0.8em;'><img style='width:95px; height:95px; margin: 0 2px;' src='");
      out.print(request.getContextPath());
      out.write("/upload/board/\"+data.imageSNSList[e].renamedFileName+\"' />\";\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\tif(data.imageSNSList[e].originalFileName.length>7){\n");
      out.write("\t\t\t\t\t\t \t\tvar dot = data.imageSNSList[e].originalFileName.substring(data.imageSNSList[e].originalFileName.indexOf('.'));\n");
      out.write("\t\t\t\t\t\t \t\tvar filename = data.imageSNSList[e].originalFileName.substr(0, 7) + \"...\" + dot;\n");
      out.write("\t\t\t\t\t\t \t}\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\thtml+=\"<span>\"+filename+\"</span>\"\n");
      out.write("\t\t\t\t\t\t\thtml+=\"</div>\";\n");
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t\thtml+=\"</div>\";\n");
      ...
      out.write("\t\t\t\t\thtml += \"</tr>\";\n");
      out.write("\t\t\t\t\thtml += \"<tr>\";\n");
      out.write("\t\t\t\t\thtml += \"<td style='float:left; padding:10px;'>\";\n");
      out.write("\t\t\t\t\thtml += \"<input type='radio' name='boardtype'  value='P' checked />\";\n");
      out.write("\t\t\t\t\thtml += \"<label for='public'>전체공개</label> &nbsp;\";\n");
      out.write("\t\t\t\t\thtml += \"<input type='radio' name='boardtype'  value='F' />\";\n");
      out.write("\t\t\t\t\thtml += \"<label for='followOnly'>팔로워공개</label> &nbsp;\";\n");
      out.write("\t\t\t\t\thtml += \"<input type='radio' name='boardtype'  value='L' />\";\n");
      ...
      out.write("'){\n");
      out.write("\t\t\t\t\thtml+=\"<button class='btn btn-success' onclick='updateBoardSNS(\"+tl.boardSNS.boardNo+\")' style='margin-right:2px;'>수정</button>\";\n");
      ...
      out.write("\t\t\tpageMore($(this).prev().attr('id').substr(7));\n");
      out.write("\t\t\t$(this).remove();\n");
      out.write("\t\t});\n");
      out.write("\t\t\n");
