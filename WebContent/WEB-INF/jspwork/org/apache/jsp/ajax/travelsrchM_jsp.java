 ...
 * Generated at: 2019-08-17 11:48:38 UTC
...
public final class travelsrchM_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String[] mcontentgrades = request.getParameterValues("mcontentgrades");
      ...
      out.write("\tvar msido1;\r\n");
      out.write("\tvar mgugun1;\r\n");
      out.write("\r\n");
      out.write("$(()=>{\r\n");
      out.write("\t");
if(mcontentids!=null){
...
for(String contentthumbnail : mcontentthumbnails){
      out.write("\r\n");
      out.write("\tmcontentthumbnails.push('");
      out.print(contentthumbnail);
      out.write("');\r\n");
      out.write("\t");
}
      out.write('\r');
...
for(String contentaddress : mcontentaddresses){
      out.write("\r\n");
      out.write("\tmcontentaddresses.push('");
      out.print(contentaddress);
      out.write("');\r\n");
      out.write("\t");
for(String contentgrade : mcontentgrades){
      out.write("\r\n");
      out.write("\tmcontentgrades.push('");
      out.print(contentgrade);
      out.write("');\r\n");
}
      out.write('\r');
      out.write('\n');
      ...
      out.write("\r\n");
      out.write("\t\r\n");
      out.write("\tif(mcontentids!=null){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfor(var q=0; q<mcontentids.length; q++){\r\n");
      out.write("\t\t\tvar html='';\r\n");
      out.write("\t\t\thtml+=\"<div class='card h-100'>\";\r\n");
      out.write("\t\t\t\thtml+=\"<a href='#' class='goInfo'><img class='card-img-top' src='\"+mcontentthumbnails[q]+\"'></a>\";\r\n");
      ...
      out.write("/travel/detailPage?contentId=\"+mcontentids[q]+\"&contentTypeId=\"+mcontenttypes[q]+\"' target='_blank'>\"+mcontenttitles[q]+\"</a>\";\r\n");
      out.write("\t\t\t\t\t\t\thtml+=\"<div class='mcontentid' style='display:none'>\"+mcontentids[q]+\"</div>\"+\"</h4>\";\r\n");
      out.write("\t\t\t\t\t\t\tif(mcontentaddresses[q]!=null){\r\n");
      out.write("\t\t\t\t\t\t\t\thtml+=\"<p class='card-text'>\"+mcontentaddresses[q]+\"</p>\"\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\thtml+=\"</div>\";\r\n");
      out.write("\t\t\t\thtml+=\"</div>\";\r\n");
      out.write("\t\t\t\thtml+=\"<div class='mstarRev'>\";\r\n");
      out.write("\t\t\t\t\tfor(var r=0; r<mcontentgrades[q]; r++){\t\r\n");
      out.write("\t\t\t\t\t\thtml+=\"<span class='mstarR on' onclick='star(this);'>별1</span>\";\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\tfor(var t=0; t<5-mcontentgrades[q]; t++){\t\r\n");
      out.write("\t\t\t\t\t\thtml+=\"<span class='mstarR' onclick='star(this);'>별2</span>\";\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\thtml+=\"</div>\"\r\n");
      out.write("\t\t\t\t\thtml+=\"</div>\";\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t$(\"#mcontents\").append(html);\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t mcontentids.pop(mcontentids.indexOf($(div).next().children().html()));\r\n");
      out.write("\t mcontenttypes.pop(mcontentids.indexOf($(div).next().children().html()));\r\n");
      out.write("\t mcontentthumbnails.pop(mcontentids.indexOf($(div).next().children().html()));\r\n");
      out.write("\t mcontenttitles.pop(mcontentids.indexOf($(div).next().children().html()));\r\n");
      out.write("\t mcontentaddresses.pop(mcontentids.indexOf($(div).next().children().html()));\r\n");
      out.write("\t mcontentgrades.pop(mcontentids.indexOf($(div).next().children().html()));\r\n");
      out.write("\t\r\n");
      ...
      out.write(" };\r\n");
      out.write("\r\n");
      out.write(" \t$(\"#msearch\").on(\"click\", function(){\r\n");
      out.write(" \t\tmsido1 = $(\"#msido1\").val();\r\n");
      out.write(" \t\tmgugun1 = $(\"#mgugun1\").val();\r\n");
      out.write(" \t});\r\n");
      out.write(" \t\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write(" $(\"select[name^=msido]\").each(function() {\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write(" $(\"select[name^=msido]\").change(function() {\r\n");
      ...
      out.write("   \tvar $li = $(\"#mautoComplete li\");\r\n");
      out.write("   \t\r\n");
      ...
      out.write("   \t\t$(\"#msearch\").val($(e.target).text().replace('+', ''));\r\n");
      out.write("   \t\t$(\"#mautoComplete\").hide().children().remove();\r\n");
      out.write("   \t\t$.ajax({\r\n");
      out.write("   \t\t\turl: \"http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?ServiceKey=S0BJm1yXPPy5UgmsERf%2BnJjnz9RkRpbFJVQXS93Ql6%2B1xk5T%2FQa15nogO4%2BOrWRSf0fo7RFFcdGsODeGZ%2BW6dQ%3D%3D&contentTypeId=&areaCode=\"+msido1+\"&sigunguCode=\"+mgugun1+\"&cat1=&cat2=&cat3=&listYN=Y&MobileOS=ETC&MobileApp=TourAPI3.0_Guide&arrange=A&numOfRows=300&pageNo=1\",\r\n");
      out.write("\t\t\t\ttype: \"get\",\r\n");
      ...
      out.write("\t\t\t\t\tvar html = \"\";\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tif($(mcontentids).length>=3){\r\n");
      out.write("\t\t\t\t\t\talert(\"여행지는 3개까지 등록 가능합니다.\");\r\n");
      out.write("\t\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t$items.each(function(i,m){\r\n");
      out.write("\t\t\t\t\t\tif($(m).find(\"title\").text()==$sel.text().replace('+', '')){\r\n");
      out.write("\t\t\t\t\t\t\tif(mcontentids.length>0){\r\n");
      out.write("\t\t\t\t\t\t\t\t  if(mcontentids.indexOf($(m).find(\"contentid\").text())!=-1){\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\thtml+=\"<div class='mcontentid' style='display:none'>\"+$(m).find(\"contentid\").text()+\"</div>\"+\"</h4>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\thtml+=\"<p class='card-text'>\"+$(m).find(\"addr1\").text()+\"</p>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+=\"</div>\";\r\n");
      out.write("\t\t\t\t\t\t\t\thtml+=\"</div>\";\r\n");
      out.write("\t\t\t\t\t\t\t\thtml+=\"<div class='mstarRev'>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+=\"<span class='mstarR' onclick='star(this);'>별1</span>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+=\"<span class='mstarR' onclick='star(this);'>별2</span>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+=\"<span class='mstarR' onclick='star(this);'>별3</span>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+=\"<span class='mstarR' onclick='star(this);'>별4</span>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+=\"<span class='mstarR' onclick='star(this);'>별5</span>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+=\"</div>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+=\"</div>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\tmcontentids.push($(m).find(\"contentid\").text());\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\tmcontenttypes.push($(m).find(\"contenttypeid\").text());\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\tif($(m).find(\"firstimage\").text()!=null){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tmcontentthumbnails.push($(m).find(\"firstimage\").text());\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}else {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tmcontentthumbnails.push(\"undefined\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\tmcontenttitles.push($(m).find(\"title\").text());\r\n");
      out.write("\t\t\t\t\t\t\t\t\tmcontentaddresses.push($(m).find(\"addr1\").text());\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\t\t\t\t}\t\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("   \t}\r\n");
      out.write("   \telse{\r\n");
      out.write("   \t\tvar search = $(\"#msearch\").val().trim();\r\n");
      out.write("   \t\t\r\n");
      ...
      out.write("   \t\t\t\t\t\t\t\t$(\"#mautoComplete\").hide();\t\t\t\t\t\t\t\r\n");
      out.write("   \t\t\t\t\t\t}else{\t\t\t\t\t\t\t\r\n");
      out.write("   \t\t\t\t\t\t\t\thtml += \"<li><span style='float:left; color:orange' padding:10px;>+</span>\"+$(m).find(\"title\").text()+\"</li>\";\r\n");
      out.write("   \t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("   \t\t\t\t\t\t\t$(\"#mautoComplete\").html(html)\r\n");
      out.write("   \t\t\t\t\t\t\t\t\t\t\t  .fadeIn(200);\r\n");
      out.write("   \t\t\t\t\t\t}\r\n");
      out.write("   \t\t\t\t\t\t\r\n");
      out.write("   \t\t\t\t\t});\r\n");
      out.write("   \t\t\t\t\t\r\n");
      out.write("   \t\t\t\t\t$(\"#mautoComplete li\").unbind(\"click\").bind(\"click\", (e=>{\t\t\t\t\t\t\r\n");
      out.write("   \t\t\t\t\t\t$(\"#msearch\").val($(e.target).text().replace('+', ''));\r\n");
      ...
      out.write("\t\t<br />\r\n");
      out.write("\t\t<select name=\"msido1\" id=\"msido1\"></select>\r\n");
      out.write("\t\t<select name=\"mgugun1\" id=\"mgugun1\"></select>\r\n");
      out.write("\t\t<div id=\"msearchFrm\">\r\n");
      out.write("\t\t\t<input hidden=\"hidden\" />\r\n");
      out.write("\t\t\t<input type=\"search\" name=\"search\" id=\"msearch\" placeholder=\"검색어입력\" onkeyup=\"searchList(event);\" size=\"27\" /> \r\n");
      out.write("\t\t\t<ul id=\"mautoComplete\" style=\"z-index:99;\">\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\t<div class=\"row\" id=\"mcontents\" style=\"margin: 0 auto;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("<style>\r\n");
      ...
      out.write("}\r\n");
      out.write("#mcontents .card-img-top, .goInfo{\r\n");
      ...
      out.write("  cursor: pointer;\r\n");
      out.write("}\r\n");
      out.write(".mstarR.on{background-position:0 0;}\r\n");
      out.write("\r\n");
      out.write(".mstarRev{\r\n");
