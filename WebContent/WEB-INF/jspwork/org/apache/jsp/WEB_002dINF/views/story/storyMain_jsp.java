 ...
 * Generated at: 2019-08-13 14:58:51 UTC
...
public final class storyMain_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/header-menu.jsp", Long.valueOf(1565708311000L));
    _jspx_dependants.put("/WEB-INF/views/story/sidenav.jsp", Long.valueOf(1565708288000L));
  }
...
if(userLoggedIn==null || userLoggedIn.getFileName()==null){
	...
	System.out.println("followLoggedInList.contains(mypage)="+followLoggedInList.contains(mypage));
      ...
      out.write("\t\t\ttype : 'post',\r\n");
      out.write("\t\t\tsuccess : function(data){\r\n");
      out.write("\t\t\t\tconsole.log(\"follow working\");\r\n");
      ...
      out.write("\t\t\ttype : 'post',\r\n");
      out.write("\t\t\tsuccess : function(data){\r\n");
      out.write("\t\t\t\tconsole.log(\"unfollow working\");\r\n");
      out.write("\t\t\t\t\r\n");
...
if(followLoggedInList.contains(mypage)){	
      out.write("\r\n");
      out.write("\t\t\t\t\t\t <br>\r\n");
      out.write("\t\t\t\t\t\t <button type=\"button\" class=\"btn btn-danger\" id=\"followBtn\" onclick=\"unfollow();\">Unfollow</button>\r\n");
      out.write("\t\t\t\t\t\t <button type=\"button\" class=\"btn btn-dark\">Block</button>\r\n");
      out.write("\t\t\t\t\t");
} else{ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-success\" id=\"followBtn\" onclick=\"follow();\">Follow</button>\r\n");
      out.write("\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-dark\">Block</button>\r\n");
      out.write("\t\t\t\t\t");
 }
			} 
      ...
      out.write("\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t      <div id=\"introFrm\" style=\"margin: 10px 0 50px;\">\r\n");
...
if(userLoggedIn!=null && userLoggedIn.getUserId().equals(mypage)) {
      ...
      out.write("\t\t\turl: \"");
      out.print(request.getContextPath() );
      out.write("/ajax/board_questionList.jsp\", \r\n");
      out.write("\t\t\ttype: \"get\",\r\n");
      out.write("\t\t\tdataType: \"html\",\r\n");
      out.write("\t\t\tsuccess: function(data){\r\n");
      out.write("\t\t\t\t$(\"#container-sns\").html(data);\r\n");
