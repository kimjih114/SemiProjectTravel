 ...
 * Generated at: 2019-08-12 22:20:15 UTC
...
public final class storyMain_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/story/sidenav.jsp", Long.valueOf(1565648413000L));
  }
...
if(userLoggedIn==null){ 
	...
	User mypageUser = new UserService().selectOne(mypage);
 	...
 	List<String> followLoggedInList = new SNSService().selectOneIdFollow(userLoggedIn.getUserId());
      ...
      out.write("\t\t\t\t$(\"#followBtn\").off('click').on('click', unfollow);\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t})\r\n");
      out.write("}\r\n");
      ...
      out.write("\t\t\t\t$(\"#followBtn\").off('click').on('click', follow);\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}) \r\n");
...
if(userLoggedIn!=null && userLoggedIn.getUserId().equals(mypage)) {
      ...
      out.write("\t   \t\r\n");
      out.write("\t   \t\t<tr>\r\n");
      out.write("\t   \t\t\t<td id=\"follower\">팔로워</td>\r\n");
      out.write("\t   \t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t   \t</table>\r\n");
      out.write("\t   \t");
if(userLoggedIn!=null && userLoggedIn.getUserId().equals(mypage)) {
      ...
      out.write("\t\t\t\t$(\"#followBtn\").off('click').on('click', follow);\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tvar html = \"<button type='button' class='btn btn-dark' id='blockBtn'>Block</button>\";\r\n");
      out.write("\t\t\t\t$(\"#darkArea\").html(html);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}) \r\n");
      out.write("\r\n");
      out.write("\t\r\n");
