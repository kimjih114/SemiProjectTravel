 ...
 * Generated at: 2019-08-19 18:47:45 UTC
...
if(userLoggedIn==null || userLoggedIn.getFileName()==null){
      ...
      out.write("\tvar si=$(\"#sido1\").val();\r\n");
      out.write("\tif(si==0){\r\n");
      out.write("\t\talert(\"시/도 를 선택해주세요\");\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/travel/travelView\" method=\"get\" onsubmit=\"return check();\">\r\n");
