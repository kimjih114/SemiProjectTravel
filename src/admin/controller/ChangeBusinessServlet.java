...
/**
 * Servlet implementation class ChangeBusinessServlet
 */
@WebServlet("/admin/changeBusiness")
public class ChangeBusinessServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChangeBusinessServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/views/admin/changeBusiness.jsp").forward(request, response);
	}
