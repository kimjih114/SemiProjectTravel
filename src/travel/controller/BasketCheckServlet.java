...
/**
 * Servlet implementation class BasketCheckServlet
 */
@WebServlet("/travel/basketCheck")
public class BasketCheckServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BasketCheckServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RoomReservation basketCheck=new TravelService().basketCheck(r);
		
		response.setContentType("application/json; charset=utf-8");
		
		new Gson().toJson(basketCheck, response.getWriter());
	}
