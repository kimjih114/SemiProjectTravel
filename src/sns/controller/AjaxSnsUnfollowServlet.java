...
/**
 * Servlet implementation class AjaxSnsUnfollowServlet
 */
@WebServlet("/gson/sns/unFollow.do")
public class AjaxSnsUnfollowServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxSnsUnfollowServlet() {
        super();
