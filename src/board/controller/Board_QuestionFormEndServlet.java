...
/**
 * Servlet implementation class Board_QuestionFormEndServlet
 */
@WebServlet("/board/boardQuestionFrmEnd")
public class Board_QuestionFormEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Board_QuestionFormEndServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result >0) {
			msg ="게시글 등록 성공"; 
			loc = "/board/qboardView?qboardNo="+result;/*"/ajax/"+result;  */  //view로 간다    
		}else {
			msg="게시글 등록실패"; 
		}
