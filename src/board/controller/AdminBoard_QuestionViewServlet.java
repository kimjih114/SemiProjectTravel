 ...
 */
@WebServlet("/board/adminqboardView")
public class AdminBoard_QuestionViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminBoard_QuestionViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!hasRead) {
			...
			request.getRequestDispatcher("/WEB-INF/views/admin/adminboard_questionView.jsp").forward(request, response);
