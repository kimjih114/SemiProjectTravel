 ...
 */
@WebServlet("/board/adminqboardUpdateEnd")
public class AdminBoard_QuestionUpdateEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminBoard_QuestionUpdateEndServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//기존에 첨부한 파일이 있다면, 후처리작업
				...
				int result = new Board_QuestionService().AdminupdateqBoard(bq); 
				
				String view = "/WEB-INF/views/common/msg.jsp"; 
				String msg = ""; 
				String loc = "/WEB-INF/views/admin/adminboard_questionList";   ///   이것도 경로         <%=request.getContextPath()%>/dfsfddf;    
				
				if(result>0) {
					msg="게시글 수정 성공"; 
					loc = "/board/adminqboardView?qboardNo="+qboardNo;
				}else {
					msg="게시글 수정 실패"; 
				}
